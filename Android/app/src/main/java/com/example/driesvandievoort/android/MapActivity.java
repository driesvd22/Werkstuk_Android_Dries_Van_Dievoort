...
public class MapActivity extends AppCompatActivity
    ...
    private final LatLng defaultLocation = new LatLng(50.816427, 4.335961);
...
*/
    ...
    /*private void showCurrentPlace() {
        ...
        if (locationPermissionGranted) {
            ...
            com.google.android.gms.tasks.Task<PlaceLikelihoodBufferResponse> placeResult =
                    ...
                    (new OnCompleteListener<PlaceLikelihoodBufferResponse>() {
                        ...
                        public void onComplete(@NonNull com.google.android.gms.tasks.Task<PlaceLikelihoodBufferResponse> task) {
                            if (task.isSuccessful() && task.getResult() != null) {
                                ...
                                likelyPlaces = (PlaceLikelihood)likelyPlaces;
